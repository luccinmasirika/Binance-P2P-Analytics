  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      <Select value={fiat} onValueChange={(v) => v && onFiatChange(v)}>
        <SelectTrigger className="w-[140px] h-8 text-[11px] font-bold bg-secondary/50 border-border hover:bg-secondary transition-colors">
      ...
      <Select value={payType} onValueChange={(v) => v && onPayTypeChange(v)}>
        <SelectTrigger className="min-w-[140px] w-auto h-8 text-[11px] font-bold bg-secondary/50 border-border hover:bg-secondary transition-colors">
      ...
      <Select value={period} onValueChange={(v) => v && onPeriodChange(v)}>
        <SelectTrigger className="w-[100px] h-8 text-[11px] font-bold bg-secondary/50 border-border hover:bg-secondary transition-colors">
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
